...
public class Numbers {
    ...
    public static long obtenerDivisor(long numero) {
        ...
        if (numero >= 1_000_000 && numero < 1000_000_000)                                 divisor = 1000000;//1.000.000 to 1.000.000.000
    ...
    public static String calcularNumero(long divisor, long numero, long[] numDesglosado) {
        ...
        devolver.append(numeros(desglosarNum(numero / divisor), numero / divisor));
        devolver.append(" " + terminaciones(numDesglosado));
        long[] y = desglosarNum(numero % divisor);
        if (y[0] != 0) {
            devolver.append(" " + numeros(desglosarNum(numero % divisor), numero % divisor).toLowerCase());
        }
    ...
    public static long words(String fraseNumeros) {
        ...
        if (fraseNumeros.contains("quintillion")) {
            ...
            return wordToNumbers(fraseNumeros, 100,2);
    ...
    /**
     * Este method solo funciona en numeros mayores a 100
     *
    ...
    public static String newNumber(String[] arrayNumeros, int cortador) {
        ...
        for (int i = cortador; i < arrayNumeros.length; i++) {
            ...
            if (cortador+1 != arrayNumeros.length){
                newNum.append(" ");
            }
        }
